...
import {
  ...
  Clock, Award, MessageSquare, Phone, CheckCircle2, BookOpen, GraduationCap
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="lg:ml-72 pt-16 lg:pt-0 min-h-screen">
        {isHomePage ? (
          <ParentHome user={user} school={school} children={children} selectedChild={selectedChild} />
        ) : (
...
const ParentHome = ({ user, school, children, selectedChild }) => {
  const quickLinks = [
    ...
    { label: 'Contact Teacher', icon: MessageSquare, path: '/parent/messages', color: 'from-blue-500 to-cyan-500' },
  ];
      ...
      {children.length > 0 && (
        <>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {children.map(child => (
              <div key={child.id} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700">
                <div className="flex items-center gap-3 mb-3">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
              <span className="text-slate-300">Total Annual Fee</span>
            ...
            <div className="flex justify-between items-center p-3 bg-emerald-500/10 rounded-lg border border-emerald-500/30">
              ...
              <span className="font-bold text-emerald-400">₹30,000</span>
            </div>
